...
int MidiFile::ticksearch(const void* first, const void* second) {
	_TickTime& a = *((_TickTime*)first);
	_TickTime& b = *((_TickTime*)second);
...
int MidiFile::secondsearch(const void* first, const void* second) {
	_TickTime& a = *((_TickTime*)first);
	_TickTime& b = *((_TickTime*)second);
